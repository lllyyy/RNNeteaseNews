    ...
    renderHeader = () => (
        <View style={{paddingVertical: 15, paddingLeft: 10, backgroundColor: color.backgroundColor}}>
            ...
            >
                ...
                <Image key="3" source={require('../imgs/img/18894007811887644.jpg')} style={{height: screen.width/6, width: screen.width*0.35, marginRight: 5}}/>
                <Image key="4" source={require('../imgs/img/18894007811887644.jpg')} style={{height: screen.width/6, width: screen.width*0.35, marginRight: 5}}/>
                <Image key="5" source={require('../imgs/img/18894007811887644.jpg')} style={{height: screen.width/6, width: screen.width*0.35, marginRight: 5}}/>
                <Image key="6" source={require('../imgs/img/18894007811887644.jpg')} style={{height: screen.width/6, width: screen.width*0.35, marginRight: 5}}/>
                <Image key="7" source={require('../imgs/img/18894007811887644.jpg')} style={{height: screen.width/6, width: screen.width*0.35, marginRight: 5}}/>
            </ScrollView>
        </View>
    );
    renderItem = ({item}) => (
