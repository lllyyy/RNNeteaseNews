    ...
    renderContent() {
        return (
            <View style={{
                ...
                <Row verticalCenter>
                    <Button style={{...wh(150, 65), backgroundColor: Color.gray2}} title={'取消'} onPress={() => this.hide()}/>
                    <Button style={{...wh(150, 65), backgroundColor: Color.red, marginLeft: px2dp(30)}} title={'退出'}
