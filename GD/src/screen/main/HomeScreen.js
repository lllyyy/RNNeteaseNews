...
import FlotScreen from "./FlotScreen";
import BrandPage from "./BrandPage";
import LocationCity from "./LocationCity";
import NotifPush from "./NotifPush";

let imgdata = [ 'https://oss.zuimeimami.com/test/mami_admin/Ad/20170913/2649.png', 'https://oss.zuimeimami.com/test/mami_admin/Ad/20170913/2649.png',
    'https://oss.zuimeimami.com/test/mami_admin/Ad/20170913/2649.png' ];
...
export default class HomeScreen extends BaseScreen {
    ...
    constructor(props) {
        super(props);
        this.setNavBarVisible(false);// 默认隐藏导航栏
    ...
    _onCategoryItemClick(category) {
        this.props.navigation.navigate('NotifPush', { data : category })
